...
public class Employee {
	...
	public String insertEmployee(String Employee_ID, String Employee_name, String Salary, String Contact, String Adress, String Nic) { 
        ...
        try { 
            ...
            String query = " insert into employee " +
                            "(`ID`,`Employee_ID`,`Employee_name`,`Salary`,`Contact`,`Adress`,`Nic`)"
                            + " values (?, ?, ?, ?, ?, ?, ?)"; 
            ...
            preparedStmt.setString(2, Employee_ID); 
            preparedStmt.setString(3, Employee_name); 
            preparedStmt.setInt(4, Integer.parseInt(Salary)); 
            preparedStmt.setDouble(5, Double.parseDouble(Contact)); 
			preparedStmt.setDouble(6, Double.parseDouble(Adress)); 
	...
	public String readEmployee() {
		...
		try { 
			...
			String query = "select * from Employeeitems"; 
			...
			while (rs.next()) { 
				...
				output += "<tr><td><input id='hidEmployee_IDUpdate'name='hidEmployee_IDUpdate' type='hidden' value='" + Employee_ID + "'>"
						+ Employee_name + "</td>";			
			    output += "<td>" + Salary + "</td>"; 
